...
#                                                        typeset -g POWERLEVEL9K_RIGHT_PROM# Generated by Powerlevel10k configuration wizard on 2026-02-16 at 18:06 CET.
...
#
#   for i in {0..255}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):PT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
